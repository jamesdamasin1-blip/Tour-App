-- Migration 024: Fix save_activity_bundle countries cast
-- Existing databases may already have migration 023 applied, so recreate the
-- RPC with a proper JSONB array -> TEXT[] conversion for activities.countries.
